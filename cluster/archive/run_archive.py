...
# -- private imports
from colabtools.utils import get_gpu_utilization, move_to_device
...
def main(model_name, max_length, epochs=5, batch_size=16, save_freq=1, verbose=2):
    ...
    model = AutoModelForTokenClassification.from_pretrained(model_name, config=config_model) # TODO force_download
